          ...
          <RevealOnScroll delay={0}>
            <div className="space-y-4">
              ...
              <p className="text-gray-300 leading-relaxed">
                Membentuk generasi pembelajar yang bahagia, kreatif, dan
                berakhlak mulia. Bergabunglah bersama keluarga besar kami.
              </p>
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-3">
                <li className="flex items-start gap-3 text-gray-300">
                  <MapPin
                    className="text-kid-yellow mt-1 flex-shrink-0"
                    size={20}
                  />
                  <span>
