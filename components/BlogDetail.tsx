  ...
  if (!post) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-gray-50">
        <h1 className="text-4xl font-display font-bold text-kid-dark mb-4">Artikel Tidak Ditemukan</h1>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="mt-12 pt-8 border-t border-gray-100 flex flex-col sm:flex-row justify-between items-center gap-6">
              <div className="flex flex-wrap gap-2">
                {post.tags.map((tag, idx) => (
                  <span key={idx} className="inline-flex items-center gap-1 bg-gray-100 text-gray-600 px-3 py-1 rounded-full text-sm hover:bg-gray-200 transition-colors cursor-default">
                    <Tag size={14} />
                    {tag}
                  </span>
                ))}
        ...
        <div className="mt-12 bg-kid-dark rounded-3xl p-8 md:p-12 text-center text-white relative overflow-hidden">
          ...
          <div className="relative z-10">
            <h3 className="font-display font-bold text-2xl mb-4">Suka dengan artikel ini?</h3>
            <p className="text-gray-300 mb-8 max-w-xl mx-auto">
              Daftarkan putra-putri Anda sekarang untuk mendapatkan pengalaman belajar terbaik di TK Bintang Ceria.
            </p>
            <button 
                onClick={() => {
                    navigate('/');
