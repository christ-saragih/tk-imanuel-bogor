...
const testimonialsData: Testimonial[] = [
  {
    ...
    content: "Sejak sekolah di sini, Kenzo jadi jauh lebih percaya diri dan mandiri. Metode belajarnya sangat menyenangkan, tidak membuat anak merasa tertekan. Gurunya sabar luar biasa!",
    rating: 5,
  ...
  },
  {
    ...
    content: "Fasilitasnya sangat aman dan bersih. Saya tenang meninggalkan anak saya di sini. Laporan perkembangan harian via aplikasi juga sangat membantu kami memantau aktivitas Luna.",
    rating: 5,
  ...
  },
  {
    ...
    content: "Anak saya dulu pemalu, sekarang jadi aktif ikut kegiatan seni dan musik. TK Bintang Ceria benar-benar tempat yang tepat untuk tumbuh kembang karakter anak.",
    rating: 5,
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <RevealOnScroll>
          <div className="text-center mb-16">
            <span className="text-kid-blue font-bold tracking-wider uppercase text-sm">Kata Orang Tua</span>
            <h2 className="font-display font-bold text-4xl text-kid-dark mt-2 mb-4">Apa Kata Mereka?</h2>
            <p className="text-gray-600 max-w-2xl mx-auto">
              Cerita bahagia dari keluarga besar TK Bintang Ceria yang telah mempercayakan buah hatinya kepada kami.
            </p>
          </div>
        </RevealOnScroll>
            ...
            <RevealOnScroll key={item.id} delay={index * 150} className="h-full">
              <div className="bg-white rounded-3xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300 relative border border-gray-100 h-full">
                ...
                <div className="flex items-center gap-4 border-t border-gray-100 pt-6 mt-auto">
                  ...
                  />
                  <div>
                    <h4 className="font-display font-bold text-kid-dark text-sm">{item.name}</h4>
                    <p className="text-xs text-kid-blue font-medium">{item.role}</p>
                  </div>
                </div>
              </div>
            </RevealOnScroll>
