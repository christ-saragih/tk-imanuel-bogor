          ...
          <div className="order-1 lg:order-2">
            <RevealOnScroll delay={100}>
              ...
              <p className="text-gray-600 text-lg leading-relaxed mb-8">
                ...
                learning). Kami percaya bahwa setiap anak itu unik dan memiliki
                potensi luar biasa yang perlu diasah dengan pendekatan yang
                tepat.
              </p>
              ...
              <div className="space-y-4 mb-10">
                {values.map((item, idx) => (
                  <div key={idx} className="flex items-start gap-3">
                    <CheckCircle
                      className="text-kid-green mt-1 flex-shrink-0"
                      size={20}
                    />
